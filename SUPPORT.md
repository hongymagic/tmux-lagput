...
could identify a person or system.

Feature and usability proposals are welcome through the feature form. There is
no private, paid, or guaranteed-response support channel.

For suspected vulnerabilities, follow [SECURITY.md](SECURITY.md). For sensitive
conduct reports, follow [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md); neither belongs
in a public issue.
